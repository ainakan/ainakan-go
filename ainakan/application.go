...
func (a *Application) Params() map[string]any {
	ht := C.ainakan_application_get_parameters(a.application)
...
func (a *Application) Clean() {
	clean(unsafe.Pointer(a.application), unrefAinakan)
}
