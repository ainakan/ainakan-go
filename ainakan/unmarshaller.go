...
const (
	...
	ainakanCrash               gTypeName = "AinakanCrash"
	ainakanSessionDetachReason gTypeName = "AinakanSessionDetachReason"
	ainakanChild               gTypeName = "AinakanChild"
	ainakanDevice              gTypeName = "AinakanDevice"
	ainakanApplication         gTypeName = "AinakanApplication"
...
var gTypeString = map[gTypeName]unmarshallerFunc{
	...
	gBytes:                   getGBytesV,
	ainakanCrash:               getAinakanCrash,
	ainakanSessionDetachReason: getAinakanSessionDetachReason,
	ainakanChild:               getAinakanChild,
	ainakanDevice:              getAinakanDevice,
	ainakanApplication:         getAinakanApplication,
	guint:                    getInt,
	gint:                     getInt,
...
func getAinakanCrash(val *C.GValue) any {
	crash := (*C.AinakanCrash)(C.g_value_get_object(val))
...
func getAinakanSessionDetachReason(val *C.GValue) any {
	reason := C.g_value_get_int(val)
	return SessionDetachReason(int(reason))
}

func getAinakanChild(val *C.GValue) any {
	child := (*C.AinakanChild)(C.g_value_get_object(val))
...
func getAinakanDevice(val *C.GValue) any {
	dev := (*C.AinakanDevice)(C.g_value_get_object(val))
...
func getAinakanApplication(val *C.GValue) any {
	app := (*C.AinakanApplication)(C.g_value_get_object(val))
