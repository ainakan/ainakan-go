...
func NewRelay(address, username, password string, kind RelayKind) *Relay {
	...
	knd := C.AinakanRelayKind(kind)

	rly := C.ainakan_relay_new(
		addressC,
		usernameC,
		passwordC,
		knd)
