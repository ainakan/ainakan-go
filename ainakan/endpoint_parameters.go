...
// EndpointParameters represent internal AinakanEndpointParameters
type EndpointParameters struct {
	params *C.AinakanEndpointParameters
}
...
func NewEndpointParameters(params *EParams) (*EndpointParameters, error) {
	...
	var authService *C.AinakanAuthenticationService = nil
	...
	if params.Token != "" {
		...
		authService = (*C.AinakanAuthenticationService)(C.ainakan_static_authentication_service_new(tknC))
	} else if params.AuthenticationCallback != nil {
		authService = (*C.AinakanAuthenticationService)(C.ainakan_go_authentication_service_new(unsafe.Pointer(&params.AuthenticationCallback)))
	}
	...
	ret := C.ainakan_endpoint_parameters_new(
		addrC,
...
func (e *EndpointParameters) SetAssetRoot(assetPath string) {
	...
	C.ainakan_endpoint_parameters_set_asset_root(e.params, assetRoot)
}

// Clean will clean the resources held by the endpoint parameters.
func (e *EndpointParameters) Clean() {
	clean(unsafe.Pointer(e.params), unrefAinakan)
}
