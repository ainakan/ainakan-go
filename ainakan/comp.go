...
func (c *CompilerOptions) SetProjectRoot(projectRoot string) {
	...
	C.ainakan_compiler_options_set_project_root(c.c, pRoot)
}
...
func (c *CompilerOptions) SetJSCompression(compress JSCompressionType) {
	C.ainakan_compiler_options_set_compression(c.c, (C.AinakanJsCompression)(compress))
}
...
func (c *CompilerOptions) SetSourceMaps(sourceMaps SourceMaps) {
	C.ainakan_compiler_options_set_source_maps(c.c, (C.AinakanSourceMaps)(sourceMaps))
}

// SetOutputFormat allows to dictate which output format.
func (c *CompilerOptions) SetOutputFormat(outputFormat OutputFormat) {
	C.ainakan_compiler_options_set_output_format(c.c, (C.AinakanOutputFormat)(outputFormat))
}

// SetBundleFormat allows to choose bundle format.
func (c *CompilerOptions) SetBundleFormat(bundleFormat BundleFormat) {
	C.ainakan_compiler_options_set_bundle_format(c.c, (C.AinakanBundleFormat)(bundleFormat))
}
...
func (c *CompilerOptions) SetTypeCheckMode(typeCheckMode TypeCheckMode) {
	C.ainakan_compiler_options_set_type_check(c.c, (C.AinakanTypeCheckMode)(typeCheckMode))
}

// Compiler type is used to compile scripts.
type Compiler struct {
	cc *C.AinakanCompiler
	fn reflect.Value
}
...
func NewCompiler() *Compiler {
	...
	cc := C.ainakan_compiler_new(mgr.getManager())
...
func (c *Compiler) Build(entrypoint string, opts *CompilerOptions) (string, error) {
	...
	var o *C.AinakanBuildOptions = nil
	if opts != nil {
		o = (*C.AinakanBuildOptions)(opts.c)
	}

	var err *C.GError
	ret := C.ainakan_compiler_build_sync(c.cc, entrypointC, o, nil, &err)
...
func (c *Compiler) Watch(entrypoint string, opts *CompilerOptions) error {
	...
	var o *C.AinakanWatchOptions = nil
	if opts != nil {
		o = (*C.AinakanWatchOptions)(opts.c)
	}

	var err *C.GError
	C.ainakan_compiler_watch_sync(c.cc, entrypointC, o, nil, &err)
	return handleGError(err)
}

// Clean will clean resources held by the compiler.
func (c *Compiler) Clean() {
	clean(unsafe.Pointer(c.cc), unrefAinakan)
}
