...
// Crash represents crash of ainakan.
type Crash struct {
	crash *C.AinakanCrash
}

// PID returns the process identifier oc.crashed application
func (c *Crash) PID() int {
	if c.crash != nil {
		return int(C.ainakan_crash_get_pid(c.crash))
	}
	return -1
}
...
func (c *Crash) ProcessName() string {
	if c.crash != nil {
		return C.GoString(C.ainakan_crash_get_process_name(c.crash))
	}
	return ""
}
...
func (c *Crash) Summary() string {
	if c.crash != nil {
		return C.GoString(C.ainakan_crash_get_summary(c.crash))
	}
	return ""
}
...
func (c *Crash) Report() string {
	if c.crash != nil {
		return C.GoString(C.ainakan_crash_get_report(c.crash))
	}
	return ""
}
...
func (c *Crash) Params() map[string]any {
	if c.crash != nil {
		ht := C.ainakan_crash_get_parameters(c.crash)
...
func (c *Crash) String() string {
	if c.crash != nil {
		return fmt.Sprintf("<AinakanCrash>: <%p>", c.crash)
	}
	return ""
}
...
func (c *Crash) Clean() {
	if c.crash != nil {
		clean(unsafe.Pointer(c.crash), unrefAinakan)
	}
}
