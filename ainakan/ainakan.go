// Package ainakan provides Go bindings for ainakan.
...
// Version returns currently used ainakan version
func Version() string {
	return C.GoString(C.ainakan_version_string())
}
